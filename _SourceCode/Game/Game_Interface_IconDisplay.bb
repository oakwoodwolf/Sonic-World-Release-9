...
CONTROLTIPS$(TIP_JUMPA[CHAR_TRI])	= "Double jump"
For i=1 to CHAR_NONMODPLAYABLECOUNT
...
CONTROLTIPS$(TIP_SKILL1[CHAR_TRI])	= "Flamethrower"
For i=1 to CHAR_NONMODPLAYABLECOUNT
...
;---------------------------------------------------------------------------
For i=1 to CHAR_NONMODPLAYABLECOUNT
	CONTROLTIPS$(TIP_SKILL2[i]) = ""
Next
CONTROLTIPS$(TIP_SKILL2[CHAR_SON])	= "Sonic wind"
...
CONTROLTIPS$(TIP_SKILL2[CHAR_TRI])	= "Fireball"
For i=1 to CHAR_NONMODPLAYABLECOUNT
...
;---------------------------------------------------------------------------
For i=1 to CHAR_NONMODPLAYABLECOUNT
	CONTROLTIPS$(TIP_SKILL3[i]) = ""
Next
CONTROLTIPS$(TIP_SKILL3[CHAR_SON])	= "Sonic boom" : TIP_HoldSKILL3[CHAR_SON]=1
...
Next
CONTROLTIPS$(TIP_SKILL3AIR[CHAR_SON])	= "Insta-Shield"
