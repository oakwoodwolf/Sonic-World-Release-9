...
Function SaveGame(saveemblems=true)
	...
	WriteLine(CurrentOpenFile,"<bloom setting="+Chr$(34)+Menu\Settings\Bloom#+Chr$(34)+"/>")
	...
	WriteLine(CurrentOpenFile,"<water setting="+Chr$(34)+Menu\Settings\WaterQuality#+Chr$(34)+"/>")
...
Function LoadGame(loademblems=true)
	...
	Select xmlNodeNameGet$(child)
		...
		Case "bloom": Menu\Settings\Bloom# = xmlNodeAttributeValueGet(child, "setting")
		...
		Case "water": Menu\Settings\WaterQuality# = xmlNodeAttributeValueGet(child, "setting")
...
Global TOUNLOCKSPECIALSTAGES[0]
	...
	Select c
		...
		Case CHAR_TIA,CHAR_HON,CHAR_TRI:						TOUNLOCKCHAR[c]=40
...
Function SaveGame_Chao(cc.tChaoManager)
	...
	WriteLine(CurrentOpenFile,"<shape is="+Chr$(34)+cc\Stats\Shape+Chr$(34)+" body="+Chr$(34)+cc\Stats\Body+Chr$(34)+"/>")
...
Function LoadGame_Chao(cc.tChaoManager)
	...
	Select xmlNodeNameGet$(child)
		...
		Case "shape": cc\Stats\Shape = xmlNodeAttributeValueGet(child, "is") : cc\Stats\Body = xmlNodeAttributeValueGet(child, "body")
