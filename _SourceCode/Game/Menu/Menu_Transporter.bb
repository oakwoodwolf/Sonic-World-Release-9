...
Function Menu_Transporter_Main()
	...
	Else
		...
		DrawSmartButtonT(3, "Select Buddy", GAME_WINDOW_W/2+BUTTON_PLACE1#*GAME_WINDOW_SCALE#, GAME_WINDOW_H/2+05*GAME_WINDOW_SCALE#, 1, true)
	EndIf
	DrawSmartButtonT(4, "Inventory", GAME_WINDOW_W/2+BUTTON_PLACE1#*GAME_WINDOW_SCALE#, GAME_WINDOW_H/2+55*GAME_WINDOW_SCALE#, 1)
	DrawSmartButtonT(5, "Exit", GAME_WINDOW_W/2+BUTTON_PLACE1#*GAME_WINDOW_SCALE#, GAME_WINDOW_H/2+105*GAME_WINDOW_SCALE#, 1)
