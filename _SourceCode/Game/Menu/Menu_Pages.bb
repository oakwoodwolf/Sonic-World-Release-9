...
Function Menu_Main_Update()
	...
	Menu\ControlsToShow=Menu\Menu
	i=1
	DrawSmartButton(i, "Play", GAME_WINDOW_W/2+BUTTON_PLACE1#*GAME_WINDOW_SCALE#, GAME_WINDOW_H/2+(-150+(42*i))*GAME_WINDOW_SCALE#) : i=i+1
	DrawSmartButton(i, "Online", GAME_WINDOW_W/2+BUTTON_PLACE1#*GAME_WINDOW_SCALE#, GAME_WINDOW_H/2+(-150+(42*i))*GAME_WINDOW_SCALE#) : i=i+1
	DrawSmartButton(i, "Gallery", GAME_WINDOW_W/2+BUTTON_PLACE1#*GAME_WINDOW_SCALE#, GAME_WINDOW_H/2+(-150+(42*i))*GAME_WINDOW_SCALE#) : i=i+1
	DrawSmartButton(i, "Options", GAME_WINDOW_W/2+BUTTON_PLACE1#*GAME_WINDOW_SCALE#, GAME_WINDOW_H/2+(-150+(42*i))*GAME_WINDOW_SCALE#) : i=i+1
	DrawSmartButton(i, "Credits", GAME_WINDOW_W/2+BUTTON_PLACE1#*GAME_WINDOW_SCALE#, GAME_WINDOW_H/2+(-150+(42*i))*GAME_WINDOW_SCALE#) : i=i+1
	DrawSmartButton(i, "Exit", GAME_WINDOW_W/2+BUTTON_PLACE1#*GAME_WINDOW_SCALE#, GAME_WINDOW_H/2+(-150+(42*i))*GAME_WINDOW_SCALE#)
...
Function Menu_Pause_Update()
	...
	SetScale(GAME_WINDOW_SCALE#, GAME_WINDOW_SCALE#)
	SetColor(255, 255, 255)
	If BP_Online Then offset=-50 Else offset=0
	i=1
	Select Menu\PauseScreen
		Case 0:
			DrawSmartButton(i, "Continue", GAME_WINDOW_W/2, GAME_WINDOW_H/2+((offset-100+50*i)*GAME_WINDOW_SCALE#)) : i=i+1
			Select Menu\ChaoGarden
				Case 0:
					DrawSmartButton(i, "Restart", GAME_WINDOW_W/2, GAME_WINDOW_H/2+((offset-100+50*i)*GAME_WINDOW_SCALE#)) : i=i+1
				Case 1:
					DrawSmartButton(i, "Restart", GAME_WINDOW_W/2, GAME_WINDOW_H/2+((offset-100+50*i)*GAME_WINDOW_SCALE#),false,false,true) : i=i+1
			End Select 
			If BP_Online Then
					DrawSmartButton(i, "Player", GAME_WINDOW_W/2, GAME_WINDOW_H/2+((offset-100+50*i)*GAME_WINDOW_SCALE#))  : i=i+1
					DrawSmartButton(i, "Server Settings", GAME_WINDOW_W/2, GAME_WINDOW_H/2+((offset-100+50*i)*GAME_WINDOW_SCALE#),False,False,Not(Game\Online\Hosting))  : i=i+1
			End If
			DrawSmartButton(i, "Quit", GAME_WINDOW_W/2, GAME_WINDOW_H/2+((offset-100+50*i)*GAME_WINDOW_SCALE#))

			DrawRealText("PAUSE", GAME_WINDOW_W/2, GAME_WINDOW_H/2+(offset-92.5)*GAME_WINDOW_SCALE#, (Interface_TextTitle_1), 1, 0, 63, 63, 63)
			...
			If (Input\Pressed\ActionJump Or Input\Pressed\Start) and Menu\Transition=0 Then
				...
				Menu\Transition=1
			EndIf
		If BP_Online Then DrawPingMenu()
		Case 1:
