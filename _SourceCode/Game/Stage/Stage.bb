...
; /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/
	...
	Const UDPMSG_CHAT 				= 11
	Const UDPMSG_MESSAGE  			= 12
	Const UDPMSG_JOINED 			= 255
	Const UDPMSG_LEFT 				= 254
	Const UDPMSG_HOSTLEFT			= 253
	Const UDPMSG_KICKED				= 252
	Const UDPMSG_PLAYERMOVEMENT 	= 1
	Const UDPMSG_PLAYERATTRIBUTES	= 2
	Const UDPMSG_PLAYERCHARACTER	= 4
	Const UDPMSG_SYNCOBJECT			= 8
	Const UDPMSG_SYNCGAMEPLAY		= 8
	Const UDPMSG_TAGVALUES			= 20
	Const UDPMSG_RACEVALUES			= 21
	Const UDPMSG_INRADIUS			= 22
	Const UDPMSG_TAGCOOLDOWN		= 23
	Const UDPMSG_GAMETYPE			= 26
							...
							Case "object"
								...
								Select xmlNodeAttributeValueGet(SceneChildNode, "type")
									...
									Case "rival","rivalrun","rival1","rivalrun1","rival2","rivalrun2","rival3","rivalrun3","rival4","rivalrun4"
										...
										If Game\RivalAmount<3 and Menu\Mission=MISSION_RIVAL# and BP_Online=False Then CreateObject()
