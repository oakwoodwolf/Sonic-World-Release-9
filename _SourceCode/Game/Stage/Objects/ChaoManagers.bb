...
; /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/
	...
	Function Object_ChaoManager_NewChao(cc.tChaoManager, Color=0, makepos=True)
		...
		cc\Stats\Hunger#=5 : cc\GetHungryTimer=300*secs#
	...
	Function Object_ChaoManager_HornInHat(hattype)
		Select hattype
			Case HAT_STRAW_0,HAT_WOOL_0,HAT_WOOL_1,HAT_WOOL_2,HAT_WOOL_3,HAT_FORMAL_0,HAT_FORMAL_1,HAT_SKULL_0,HAT_BUCKET_0,HAT_TUNIC_0,HAT_TUNIC_1,HAT_TUNIC_2,HAT_TUNIC_3,HAT_BEANIE_0,HAT_BEANIE_1,HAT_BEANIE_2,HAT_BEANIE_3,HAT_FPOT_0,HAT_CARDBOARD_0,HAT_SHELL_0,HAT_PLUMBER_0,HAT_PLUMBER_1,HAT_PLUMBER_2,HAT_PLUMBER_3,HAT_PLUMBER_4,HAT_BANDANA_0,HAT_BANDANA_1,HAT_BANDANA_2,HAT_BANDANA_3,HAT_BANDANA_4, HAT_PUMPKIN_0, HAT_TURBAN_0, HAT_HOOD_0, HAT_HOOD_1, HAT_SONICMAN_0, HAT_SONICMAN_1:
				Return True
			Default:
				Return False
		End Select
	...
	Function Object_ChaoManager_Update(cc.tChaoManager, d.tDeltaTime)
		...
		If cc\PreviousAnimation<>cc\Animation Then
			Select cc\Animation
				Case CHAOANIMATION_RUN:
					Animate (cc\Mesh,1,0.5,cc\Animation,10)
				Case CHAOANIMATION_RUNAIR,CHAOANIMATION_INTIMIDATE,CHAOANIMATION_THROWN:
					Animate (cc\Mesh,1,0.3188,cc\Animation,10)
				Case CHAOANIMATION_EXCLAMATION,CHAOANIMATION_QUESTIONING,CHAOANIMATION_EXCLAMATIONAIR,CHAOANIMATION_QUESTIONINGAIR:
...
; /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/
	...
	Function ChaoManager_AgeUp(cc.tChaoManager, born=False)
		...
		Select cc\Stats\Age
			...
			Case 3: cc\HatchTimer=(6800+Rand(-1200,1200))*secs#
		...
		Select parent1
			Case CHAOCOLOR_CELESTE:
				Select parent2
					...
					Case CHAOCOLOR_CELESTE2:	Return CHAOCOLOR_CELESTE
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_BLUE
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_AZURE
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_CELESTE
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_AZURE
					Case CHAOCOLOR_BLACK2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_RED2:	Return CHAOCOLOR_PINK
					Case CHAOCOLOR_ORANGE2:	Return CHAOCOLOR_YELLOW
					Case CHAOCOLOR_YELLOW2:	Return CHAOCOLOR_LIME
					Case CHAOCOLOR_BROWN2:	Return CHAOCOLOR_ORANGE
					Case CHAOCOLOR_GREEN2:	Return CHAOCOLOR_LIME
					Case CHAOCOLOR_LIME2:	Return CHAOCOLOR_AZURE
					Case CHAOCOLOR_PURPLE2:	Return CHAOCOLOR_PINK
					Case CHAOCOLOR_PINK2:	Return CHAOCOLOR_RED
				End Select
			Case CHAOCOLOR_CELESTE2:
				Select parent2
					Case CHAOCOLOR_CELESTE:	Return CHAOCOLOR_CELESTE2
					Case CHAOCOLOR_AZURE:	Return CHAOCOLOR_BLUE2
					Case CHAOCOLOR_BLUE:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_WHITE:	Return CHAOCOLOR_CELESTE2
					Case CHAOCOLOR_GREY:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_BLACK:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_RED:	Return CHAOCOLOR_PINK2
					Case CHAOCOLOR_ORANGE:	Return CHAOCOLOR_YELLOW2
					Case CHAOCOLOR_YELLOW:	Return CHAOCOLOR_LIME2
					Case CHAOCOLOR_BROWN:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_GREEN:	Return CHAOCOLOR_LIME2
					Case CHAOCOLOR_LIME:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_PURPLE:	Return CHAOCOLOR_PINK2
					Case CHAOCOLOR_PINK:	Return CHAOCOLOR_RED2
					Case CHAOCOLOR_CELESTE2:	Return CHAOCOLOR_CELESTE2
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_BLUE2
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_CELESTE2
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_BLACK2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_RED2:	Return CHAOCOLOR_PINK2
					Case CHAOCOLOR_ORANGE2:	Return CHAOCOLOR_YELLOW2
					Case CHAOCOLOR_YELLOW2:	Return CHAOCOLOR_LIME2
					Case CHAOCOLOR_BROWN2:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_GREEN2:	Return CHAOCOLOR_LIME2
					Case CHAOCOLOR_LIME2:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_PURPLE2:	Return CHAOCOLOR_PINK2
					Case CHAOCOLOR_PINK2:	Return CHAOCOLOR_RED2
				End Select
			Case CHAOCOLOR_AZURE:
				Select parent2
					...
					Case CHAOCOLOR_CELESTE2:	Return CHAOCOLOR_BLUE
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_AZURE
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_BLUE
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_CELESTE
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_AZURE
					Case CHAOCOLOR_BLACK2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_RED2:	Return CHAOCOLOR_PURPLE
					Case CHAOCOLOR_ORANGE2:	Return CHAOCOLOR_BROWN
					Case CHAOCOLOR_YELLOW2:	Return CHAOCOLOR_GREEN
					Case CHAOCOLOR_BROWN2:	Return CHAOCOLOR_ORANGE
					Case CHAOCOLOR_GREEN2:	Return CHAOCOLOR_GREEN
					Case CHAOCOLOR_LIME2:	Return CHAOCOLOR_CELESTE
					Case CHAOCOLOR_PURPLE2:	Return CHAOCOLOR_RED
					Case CHAOCOLOR_PINK2:	Return CHAOCOLOR_CELESTE
				End Select
			Case CHAOCOLOR_AZURE2:
				Select parent2
					Case CHAOCOLOR_CELESTE:	Return CHAOCOLOR_BLUE2
					Case CHAOCOLOR_AZURE:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_BLUE:	Return CHAOCOLOR_BLUE2
					Case CHAOCOLOR_WHITE:	Return CHAOCOLOR_CELESTE2
					Case CHAOCOLOR_GREY:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_BLACK:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_RED:	Return CHAOCOLOR_PURPLE2
					Case CHAOCOLOR_ORANGE:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_YELLOW:	Return CHAOCOLOR_GREEN2
					Case CHAOCOLOR_BROWN:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_GREEN:	Return CHAOCOLOR_GREEN2
					Case CHAOCOLOR_LIME:	Return CHAOCOLOR_CELESTE2
					Case CHAOCOLOR_PURPLE:	Return CHAOCOLOR_RED2
					Case CHAOCOLOR_PINK:	Return CHAOCOLOR_CELESTE2
					Case CHAOCOLOR_CELESTE2:	Return CHAOCOLOR_BLUE2
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_BLUE2
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_CELESTE2
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_BLACK2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_RED2:	Return CHAOCOLOR_PURPLE2
					Case CHAOCOLOR_ORANGE2:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_YELLOW2:	Return CHAOCOLOR_GREEN2
					Case CHAOCOLOR_BROWN2:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_GREEN2:	Return CHAOCOLOR_GREEN2
					Case CHAOCOLOR_LIME2:	Return CHAOCOLOR_CELESTE2
					Case CHAOCOLOR_PURPLE2:	Return CHAOCOLOR_RED2
					Case CHAOCOLOR_PINK2:	Return CHAOCOLOR_CELESTE2
				End Select
			Case CHAOCOLOR_BLUE:
				Select parent2
					...
					Case CHAOCOLOR_CELESTE2:	Return CHAOCOLOR_AZURE
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_BLUE
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_BLUE
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_AZURE
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_BLUE
					Case CHAOCOLOR_BLACK2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_RED2:	Return CHAOCOLOR_PURPLE
					Case CHAOCOLOR_ORANGE2:	Return CHAOCOLOR_BROWN
					Case CHAOCOLOR_YELLOW2:	Return CHAOCOLOR_GREEN
					Case CHAOCOLOR_BROWN2:	Return CHAOCOLOR_ORANGE
					Case CHAOCOLOR_GREEN2:	Return CHAOCOLOR_BLUE
					Case CHAOCOLOR_LIME2:	Return CHAOCOLOR_AZURE
					Case CHAOCOLOR_PURPLE2:	Return CHAOCOLOR_RED
					Case CHAOCOLOR_PINK2:	Return CHAOCOLOR_AZURE
				End Select
			Case CHAOCOLOR_BLUE2:
				Select parent2
					Case CHAOCOLOR_CELESTE:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_AZURE:	Return CHAOCOLOR_BLUE2
					Case CHAOCOLOR_BLUE:	Return CHAOCOLOR_BLUE2
					Case CHAOCOLOR_WHITE:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_GREY:	Return CHAOCOLOR_BLUE2
					Case CHAOCOLOR_BLACK:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_RED:	Return CHAOCOLOR_PURPLE2
					Case CHAOCOLOR_ORANGE:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_YELLOW:	Return CHAOCOLOR_GREEN2
					Case CHAOCOLOR_BROWN:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_GREEN:	Return CHAOCOLOR_BLUE2
					Case CHAOCOLOR_LIME:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_PURPLE:	Return CHAOCOLOR_RED2
					Case CHAOCOLOR_PINK:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_CELESTE2:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_BLUE2
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_BLUE2
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_BLUE2
					Case CHAOCOLOR_BLACK2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_RED2:	Return CHAOCOLOR_PURPLE2
					Case CHAOCOLOR_ORANGE2:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_YELLOW2:	Return CHAOCOLOR_GREEN2
					Case CHAOCOLOR_BROWN2:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_GREEN2:	Return CHAOCOLOR_BLUE2
					Case CHAOCOLOR_LIME2:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_PURPLE2:	Return CHAOCOLOR_RED2
					Case CHAOCOLOR_PINK2:	Return CHAOCOLOR_AZURE2
				End Select
			Case CHAOCOLOR_WHITE:
				Select parent2
					...
					Case CHAOCOLOR_CELESTE2:	Return CHAOCOLOR_CELESTE
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_CELESTE
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_AZURE
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_WHITE
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_GREY
					Case CHAOCOLOR_BLACK2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_RED2:	Return CHAOCOLOR_ORANGE
					Case CHAOCOLOR_ORANGE2:	Return CHAOCOLOR_YELLOW
					Case CHAOCOLOR_YELLOW2:	Return CHAOCOLOR_YELLOW
					Case CHAOCOLOR_BROWN2:	Return CHAOCOLOR_ORANGE
					Case CHAOCOLOR_GREEN2:	Return CHAOCOLOR_LIME
					Case CHAOCOLOR_LIME2:	Return CHAOCOLOR_LIME
					Case CHAOCOLOR_PURPLE2:	Return CHAOCOLOR_PINK
					Case CHAOCOLOR_PINK2:	Return CHAOCOLOR_PINK
				End Select
			Case CHAOCOLOR_WHITE2:
				Select parent2
					Case CHAOCOLOR_CELESTE:	Return CHAOCOLOR_CELESTE2
					Case CHAOCOLOR_AZURE:	Return CHAOCOLOR_CELESTE2
					Case CHAOCOLOR_BLUE:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_WHITE:	Return CHAOCOLOR_WHITE2
					Case CHAOCOLOR_GREY:	Return CHAOCOLOR_GREY2
					Case CHAOCOLOR_BLACK:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_RED:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_ORANGE:	Return CHAOCOLOR_YELLOW2
					Case CHAOCOLOR_YELLOW:	Return CHAOCOLOR_YELLOW2
					Case CHAOCOLOR_BROWN:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_GREEN:	Return CHAOCOLOR_LIME2
					Case CHAOCOLOR_LIME:	Return CHAOCOLOR_LIME2
					Case CHAOCOLOR_PURPLE:	Return CHAOCOLOR_PINK2
					Case CHAOCOLOR_PINK:	Return CHAOCOLOR_PINK2
					Case CHAOCOLOR_CELESTE2:	Return CHAOCOLOR_CELESTE2
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_CELESTE2
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_WHITE2
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_GREY2
					Case CHAOCOLOR_BLACK2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_RED2:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_ORANGE2:	Return CHAOCOLOR_YELLOW2
					Case CHAOCOLOR_YELLOW2:	Return CHAOCOLOR_YELLOW2
					Case CHAOCOLOR_BROWN2:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_GREEN2:	Return CHAOCOLOR_LIME2
					Case CHAOCOLOR_LIME2:	Return CHAOCOLOR_LIME2
					Case CHAOCOLOR_PURPLE2:	Return CHAOCOLOR_PINK2
					Case CHAOCOLOR_PINK2:	Return CHAOCOLOR_PINK2
				End Select
			Case CHAOCOLOR_GREY:
				Select parent2
					Case CHAOCOLOR_CELESTE:	Return CHAOCOLOR_AZURE
					...
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_AZURE
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_BLUE
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_GREY
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_GREY
					Case CHAOCOLOR_BLACK2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_RED2:	Return CHAOCOLOR_ORANGE
					Case CHAOCOLOR_ORANGE2:	Return CHAOCOLOR_YELLOW
					Case CHAOCOLOR_YELLOW2:	Return CHAOCOLOR_BROWN
					Case CHAOCOLOR_BROWN2:	Return CHAOCOLOR_YELLOW
					Case CHAOCOLOR_GREEN2:	Return CHAOCOLOR_LIME
					Case CHAOCOLOR_LIME2:	Return CHAOCOLOR_GREEN
					Case CHAOCOLOR_PURPLE2:	Return CHAOCOLOR_PINK
					Case CHAOCOLOR_PINK2:	Return CHAOCOLOR_PURPLE
				End Select
			Case CHAOCOLOR_GREY2:
				Select parent2
					Case CHAOCOLOR_CELESTE:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_AZURE:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_BLUE:	Return CHAOCOLOR_BLUE2
					Case CHAOCOLOR_WHITE:	Return CHAOCOLOR_GREY2
					Case CHAOCOLOR_GREY:	Return CHAOCOLOR_GREY2
					Case CHAOCOLOR_BLACK:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_RED:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_ORANGE:	Return CHAOCOLOR_YELLOW2
					Case CHAOCOLOR_YELLOW:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_BROWN:	Return CHAOCOLOR_YELLOW2
					Case CHAOCOLOR_GREEN:	Return CHAOCOLOR_LIME2
					Case CHAOCOLOR_LIME:	Return CHAOCOLOR_GREEN2
					Case CHAOCOLOR_PURPLE:	Return CHAOCOLOR_PINK2
					Case CHAOCOLOR_PINK:	Return CHAOCOLOR_PURPLE2
					Case CHAOCOLOR_CELESTE2:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_BLUE2
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_GREY2
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_GREY2
					Case CHAOCOLOR_BLACK2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_RED2:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_ORANGE2:	Return CHAOCOLOR_YELLOW2
					Case CHAOCOLOR_YELLOW2:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_BROWN2:	Return CHAOCOLOR_YELLOW2
					Case CHAOCOLOR_GREEN2:	Return CHAOCOLOR_LIME2
					Case CHAOCOLOR_LIME2:	Return CHAOCOLOR_GREEN2
					Case CHAOCOLOR_PURPLE2:	Return CHAOCOLOR_PINK2
					Case CHAOCOLOR_PINK2:	Return CHAOCOLOR_PURPLE2
				End Select
			Case CHAOCOLOR_BLACK:
				Select parent2
					...
					Case CHAOCOLOR_CELESTE2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_BLACK2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_RED2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_ORANGE2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_YELLOW2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_BROWN2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_GREEN2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_LIME2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_PURPLE2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_PINK2:	Return CHAOCOLOR_BLACK
				End Select
			Case CHAOCOLOR_BLACK2:
				Select parent2
					Case CHAOCOLOR_CELESTE:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_AZURE:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_BLUE:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_WHITE:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_GREY:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_BLACK:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_RED:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_ORANGE:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_YELLOW:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_BROWN:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_GREEN:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_LIME:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_PURPLE:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_PINK:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_CELESTE2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_BLACK2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_RED2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_ORANGE2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_YELLOW2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_BROWN2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_GREEN2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_LIME2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_PURPLE2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_PINK2:	Return CHAOCOLOR_BLACK2
				End Select
			Case CHAOCOLOR_RED:
				Select parent2
					...
					Case CHAOCOLOR_PINK:	Return CHAOCOLOR_RED
					Case CHAOCOLOR_CELESTE2:	Return CHAOCOLOR_LIME
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_GREEN
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_GREEN
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_ORANGE
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_RED
					Case CHAOCOLOR_BLACK2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_RED2:	Return CHAOCOLOR_RED
					Case CHAOCOLOR_ORANGE2:	Return CHAOCOLOR_RED
					Case CHAOCOLOR_YELLOW2:	Return CHAOCOLOR_ORANGE
					Case CHAOCOLOR_BROWN2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_GREEN2:	Return CHAOCOLOR_BROWN
					Case CHAOCOLOR_LIME2:	Return CHAOCOLOR_BROWN
					Case CHAOCOLOR_PURPLE2:	Return CHAOCOLOR_BLUE
					Case CHAOCOLOR_PINK2:	Return CHAOCOLOR_RED
				End Select
			Case CHAOCOLOR_RED2:
				Select parent2
					Case CHAOCOLOR_CELESTE:	Return CHAOCOLOR_LIME2
					Case CHAOCOLOR_AZURE:	Return CHAOCOLOR_GREEN2
					Case CHAOCOLOR_BLUE:	Return CHAOCOLOR_GREEN2
					Case CHAOCOLOR_WHITE:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_GREY:	Return CHAOCOLOR_RED2
					Case CHAOCOLOR_BLACK:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_RED:	Return CHAOCOLOR_RED2
					Case CHAOCOLOR_ORANGE:	Return CHAOCOLOR_RED2
					Case CHAOCOLOR_YELLOW:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_BROWN:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_GREEN:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_LIME:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_PURPLE:	Return CHAOCOLOR_BLUE2
					Case CHAOCOLOR_PINK:	Return CHAOCOLOR_RED2
					Case CHAOCOLOR_CELESTE2:	Return CHAOCOLOR_LIME2
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_GREEN2
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_GREEN2
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_RED2
					Case CHAOCOLOR_BLACK2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_RED2:	Return CHAOCOLOR_RED2
					Case CHAOCOLOR_ORANGE2:	Return CHAOCOLOR_RED2
					Case CHAOCOLOR_YELLOW2:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_BROWN2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_GREEN2:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_LIME2:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_PURPLE2:	Return CHAOCOLOR_BLUE2
					Case CHAOCOLOR_PINK2:	Return CHAOCOLOR_RED2
				End Select
			Case CHAOCOLOR_ORANGE:
				Select parent2
					...
					Case CHAOCOLOR_CELESTE2:	Return CHAOCOLOR_LIME
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_LIME
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_GREEN
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_YELLOW
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_ORANGE
					Case CHAOCOLOR_BLACK2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_RED2:	Return CHAOCOLOR_RED
					Case CHAOCOLOR_ORANGE2:	Return CHAOCOLOR_ORANGE
					Case CHAOCOLOR_YELLOW2:	Return CHAOCOLOR_ORANGE
					Case CHAOCOLOR_BROWN2:	Return CHAOCOLOR_BROWN
					Case CHAOCOLOR_GREEN2:	Return CHAOCOLOR_BROWN
					Case CHAOCOLOR_LIME2:	Return CHAOCOLOR_YELLOW
					Case CHAOCOLOR_PURPLE2:	Return CHAOCOLOR_RED
					Case CHAOCOLOR_PINK2:	Return CHAOCOLOR_ORANGE
				End Select
			Case CHAOCOLOR_ORANGE2:
				Select parent2
					Case CHAOCOLOR_CELESTE:	Return CHAOCOLOR_LIME2
					Case CHAOCOLOR_AZURE:	Return CHAOCOLOR_LIME2
					Case CHAOCOLOR_BLUE:	Return CHAOCOLOR_GREEN2
					Case CHAOCOLOR_WHITE:	Return CHAOCOLOR_YELLOW2
					Case CHAOCOLOR_GREY:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_BLACK:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_RED:	Return CHAOCOLOR_RED2
					Case CHAOCOLOR_ORANGE:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_YELLOW:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_BROWN:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_GREEN:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_LIME:	Return CHAOCOLOR_YELLOW2
					Case CHAOCOLOR_PURPLE:	Return CHAOCOLOR_RED2
					Case CHAOCOLOR_PINK:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_CELESTE2:	Return CHAOCOLOR_LIME2
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_LIME2
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_GREEN2
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_YELLOW2
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_BLACK2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_RED2:	Return CHAOCOLOR_RED2
					Case CHAOCOLOR_ORANGE2:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_YELLOW2:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_BROWN2:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_GREEN2:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_LIME2:	Return CHAOCOLOR_YELLOW2
					Case CHAOCOLOR_PURPLE2:	Return CHAOCOLOR_RED2
					Case CHAOCOLOR_PINK2:	Return CHAOCOLOR_ORANGE2
				End Select
			Case CHAOCOLOR_YELLOW:
				Select parent2
					...
					Case CHAOCOLOR_PURPLE:	Return CHAOCOLOR_PINK
					Case CHAOCOLOR_PINK:	Return CHAOCOLOR_PINK
					Case CHAOCOLOR_CELESTE2:	Return CHAOCOLOR_ORANGE
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_ORANGE
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_RED
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_YELLOW
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_ORANGE
					Case CHAOCOLOR_BLACK2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_RED2:	Return CHAOCOLOR_ORANGE
					...
					Case CHAOCOLOR_PINK2:	Return CHAOCOLOR_PINK
				End Select
			Case CHAOCOLOR_YELLOW2:
				Select parent2
					Case CHAOCOLOR_CELESTE:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_AZURE:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_BLUE:	Return CHAOCOLOR_RED2
					Case CHAOCOLOR_WHITE:	Return CHAOCOLOR_YELLOW2
					Case CHAOCOLOR_GREY:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_BLACK:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_RED:	Return CHAOCOLOR_ORANGE2
					...
					Case CHAOCOLOR_PURPLE:	Return CHAOCOLOR_PINK2
					Case CHAOCOLOR_PINK:	Return CHAOCOLOR_PINK2
					Case CHAOCOLOR_CELESTE2:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_RED2
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_YELLOW2
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_BLACK2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_RED2:	Return CHAOCOLOR_ORANGE2
			...
			Case CHAOCOLOR_BROWN:
				Select parent2
					...
					Case CHAOCOLOR_PINK:	Return CHAOCOLOR_PURPLE
					Case CHAOCOLOR_CELESTE2:	Return CHAOCOLOR_BROWN
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_ORANGE
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_ORANGE
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_BROWN
					Case CHAOCOLOR_BLACK2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_RED2:	Return CHAOCOLOR_BROWN
					Case CHAOCOLOR_ORANGE2:	Return CHAOCOLOR_BROWN
					Case CHAOCOLOR_YELLOW2:	Return CHAOCOLOR_ORANGE
					Case CHAOCOLOR_BROWN2:	Return CHAOCOLOR_BROWN
					Case CHAOCOLOR_GREEN2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_LIME2:	Return CHAOCOLOR_GREEN
					Case CHAOCOLOR_PURPLE2:	Return CHAOCOLOR_PURPLE
					Case CHAOCOLOR_PINK2:	Return CHAOCOLOR_PURPLE
				End Select
			Case CHAOCOLOR_BROWN2:
				Select parent2
					Case CHAOCOLOR_CELESTE:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_AZURE:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_BLUE:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_WHITE:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_GREY:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_BLACK:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_RED:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_ORANGE:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_YELLOW:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_BROWN:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_GREEN:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_LIME:	Return CHAOCOLOR_GREEN2
					Case CHAOCOLOR_PURPLE:	Return CHAOCOLOR_PURPLE2
					Case CHAOCOLOR_PINK:	Return CHAOCOLOR_PURPLE2
					Case CHAOCOLOR_CELESTE2:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_BLACK2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_RED2:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_ORANGE2:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_YELLOW2:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_BROWN2:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_GREEN2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_LIME2:	Return CHAOCOLOR_GREEN2
					Case CHAOCOLOR_PURPLE2:	Return CHAOCOLOR_PURPLE2
					Case CHAOCOLOR_PINK2:	Return CHAOCOLOR_PURPLE2
				End Select
			Case CHAOCOLOR_GREEN:
				Select parent2
					...
					Case CHAOCOLOR_CELESTE2:	Return CHAOCOLOR_ORANGE
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_ORANGE
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_BROWN
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_LIME
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_GREEN
					Case CHAOCOLOR_BLACK2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_RED2:	Return CHAOCOLOR_BROWN
					Case CHAOCOLOR_ORANGE2:	Return CHAOCOLOR_RED
					Case CHAOCOLOR_YELLOW2:	Return CHAOCOLOR_LIME
					...
					Case CHAOCOLOR_PINK2:	Return CHAOCOLOR_RED
				End Select
			Case CHAOCOLOR_GREEN2:
				Select parent2
					Case CHAOCOLOR_CELESTE:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_AZURE:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_BLUE:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_WHITE:	Return CHAOCOLOR_LIME2
					Case CHAOCOLOR_GREY:	Return CHAOCOLOR_GREEN2
					Case CHAOCOLOR_BLACK:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_RED:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_ORANGE:	Return CHAOCOLOR_RED2
					Case CHAOCOLOR_YELLOW:	Return CHAOCOLOR_LIME2
					...
					Case CHAOCOLOR_CELESTE2:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_LIME2
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_GREEN2
					Case CHAOCOLOR_BLACK2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_RED2:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_ORANGE2:	Return CHAOCOLOR_RED2
					Case CHAOCOLOR_YELLOW2:	Return CHAOCOLOR_LIME2
			...
			Case CHAOCOLOR_LIME:
				Select parent2
					...
					Case CHAOCOLOR_PURPLE:	Return CHAOCOLOR_PINK
					Case CHAOCOLOR_PINK:	Return CHAOCOLOR_PINK
					Case CHAOCOLOR_CELESTE2:	Return CHAOCOLOR_GREEN
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_CELESTE
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_AZURE
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_LIME
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_GREEN
					...
					Case CHAOCOLOR_PINK2:	Return CHAOCOLOR_PINK
				End Select
			Case CHAOCOLOR_LIME2:
				Select parent2
					Case CHAOCOLOR_CELESTE:	Return CHAOCOLOR_GREEN2
					Case CHAOCOLOR_AZURE:	Return CHAOCOLOR_CELESTE2
					Case CHAOCOLOR_BLUE:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_WHITE:	Return CHAOCOLOR_LIME2
					Case CHAOCOLOR_GREY:	Return CHAOCOLOR_GREEN2
					...
					Case CHAOCOLOR_PURPLE:	Return CHAOCOLOR_PINK2
					Case CHAOCOLOR_PINK:	Return CHAOCOLOR_PINK2
					Case CHAOCOLOR_CELESTE2:	Return CHAOCOLOR_GREEN2
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_CELESTE2
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_LIME2
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_GREEN2
			...
			Case CHAOCOLOR_PURPLE:
				Select parent2
					...
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_AZURE
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_RED
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_PINK
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_PURPLE
					Case CHAOCOLOR_BLACK2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_RED2:	Return CHAOCOLOR_BROWN
					Case CHAOCOLOR_ORANGE2:	Return CHAOCOLOR_BLUE2
					Case CHAOCOLOR_YELLOW2:	Return CHAOCOLOR_PINK
					Case CHAOCOLOR_BROWN2:	Return CHAOCOLOR_BROWN
					Case CHAOCOLOR_GREEN2:	Return CHAOCOLOR_BROWN
					Case CHAOCOLOR_LIME2:	Return CHAOCOLOR_YELLOW
					Case CHAOCOLOR_PURPLE2:	Return CHAOCOLOR_PURPLE
					Case CHAOCOLOR_PINK2:	Return CHAOCOLOR_PURPLE
				End Select
			Case CHAOCOLOR_PURPLE2:
				Select parent2
					Case CHAOCOLOR_CELESTE:	Return CHAOCOLOR_BLUE2
					Case CHAOCOLOR_AZURE:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_BLUE:	Return CHAOCOLOR_RED2
					Case CHAOCOLOR_WHITE:	Return CHAOCOLOR_PINK2
					Case CHAOCOLOR_GREY:	Return CHAOCOLOR_PURPLE2
					Case CHAOCOLOR_BLACK:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_RED:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_ORANGE:	Return CHAOCOLOR_BLUE2
					Case CHAOCOLOR_YELLOW:	Return CHAOCOLOR_PINK2
					Case CHAOCOLOR_BROWN:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_GREEN:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_LIME:	Return CHAOCOLOR_YELLOW2
					Case CHAOCOLOR_PURPLE:	Return CHAOCOLOR_PURPLE2
					...
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_RED2
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_PINK2
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_PURPLE2
					Case CHAOCOLOR_BLACK2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_RED2:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_ORANGE2:	Return CHAOCOLOR_BLUE2
					Case CHAOCOLOR_YELLOW2:	Return CHAOCOLOR_PINK2
					Case CHAOCOLOR_BROWN2:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_GREEN2:	Return CHAOCOLOR_BROWN2
					Case CHAOCOLOR_LIME2:	Return CHAOCOLOR_YELLOW2
					Case CHAOCOLOR_PURPLE2:	Return CHAOCOLOR_PURPLE2
			...
			Case CHAOCOLOR_PINK:
				Select parent2
					...
					Case CHAOCOLOR_CELESTE2:	Return CHAOCOLOR_AZURE
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_CELESTE
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_PURPLE
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_PINK
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_GREY
					Case CHAOCOLOR_BLACK2:	Return CHAOCOLOR_BLACK
					Case CHAOCOLOR_RED2:	Return CHAOCOLOR_ORANGE
					Case CHAOCOLOR_ORANGE2:	Return CHAOCOLOR_YELLOW
					Case CHAOCOLOR_YELLOW2:	Return CHAOCOLOR_PINK
					Case CHAOCOLOR_BROWN2:	Return CHAOCOLOR_PURPLE
					Case CHAOCOLOR_GREEN2:	Return CHAOCOLOR_LIME
					Case CHAOCOLOR_LIME2:	Return CHAOCOLOR_GREEN
					Case CHAOCOLOR_PURPLE2:	Return CHAOCOLOR_PINK
					Case CHAOCOLOR_PINK2:	Return CHAOCOLOR_PINK
				End Select
			Case CHAOCOLOR_PINK2:
				Select parent2
					Case CHAOCOLOR_CELESTE:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_AZURE:	Return CHAOCOLOR_CELESTE2
					Case CHAOCOLOR_BLUE:	Return CHAOCOLOR_PURPLE2
					Case CHAOCOLOR_WHITE:	Return CHAOCOLOR_PINK2
					Case CHAOCOLOR_GREY:	Return CHAOCOLOR_GREY2
					Case CHAOCOLOR_BLACK:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_RED:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_ORANGE:	Return CHAOCOLOR_YELLOW2
					Case CHAOCOLOR_YELLOW:	Return CHAOCOLOR_PINK2
					Case CHAOCOLOR_BROWN:	Return CHAOCOLOR_PURPLE2
					Case CHAOCOLOR_GREEN:	Return CHAOCOLOR_LIME2
					Case CHAOCOLOR_LIME:	Return CHAOCOLOR_GREEN2
					Case CHAOCOLOR_PURPLE:	Return CHAOCOLOR_PINK2
					Case CHAOCOLOR_PINK:	Return CHAOCOLOR_PINK2
					Case CHAOCOLOR_CELESTE2:	Return CHAOCOLOR_AZURE2
					Case CHAOCOLOR_AZURE2:	Return CHAOCOLOR_CELESTE2
					Case CHAOCOLOR_BLUE2:	Return CHAOCOLOR_PURPLE2
					Case CHAOCOLOR_WHITE2:	Return CHAOCOLOR_PINK2
					Case CHAOCOLOR_GREY2:	Return CHAOCOLOR_GREY2
					Case CHAOCOLOR_BLACK2:	Return CHAOCOLOR_BLACK2
					Case CHAOCOLOR_RED2:	Return CHAOCOLOR_ORANGE2
					Case CHAOCOLOR_ORANGE2:	Return CHAOCOLOR_YELLOW2
					Case CHAOCOLOR_YELLOW2:	Return CHAOCOLOR_PINK2
					Case CHAOCOLOR_BROWN2:	Return CHAOCOLOR_PURPLE2
					Case CHAOCOLOR_GREEN2:	Return CHAOCOLOR_LIME2
					Case CHAOCOLOR_LIME2:	Return CHAOCOLOR_GREEN2
					Case CHAOCOLOR_PURPLE2:	Return CHAOCOLOR_PINK2
					Case CHAOCOLOR_PINK2:	Return CHAOCOLOR_PINK2
