...
Function LoadSmartEntity(x)
	...
	Select x
		Case Mesh_JumpPanel:		MESHES(x) = LoadAnimMesh("Objects/JumpPanel/JumpPanel.b3d") : ScaleEntity MESHES(x),1.5,1.5,1.5
		Case Mesh_JumpPanel2:		MESHES(x) = LoadAnimMesh("Objects/JumpPanel/JumpPanel2.b3d") : ScaleEntity MESHES(x),1.5,1.5,1.5
			
			
			
			
		Case Mesh_StageVisual1	
			If FileType(Game\Stage\Properties\Path$+"Objects/Visuals/Custom1.b3d") =1 Then
				MESHES(x) = LoadAnimMesh(Game\Stage\Properties\Path$+"Objects/Visuals/Custom1.b3d") 
			Else
				MESHES(x) = LoadAnimMesh("Objects/Empty.b3d") : 
			EndIf 
			ExtractAnimSeq(MESHES(x),1,17)
		Case Mesh_StageVisual2	
			If FileType(Game\Stage\Properties\Path$+"Objects/Visuals/Custom2.b3d") =1 Then
				MESHES(x) = LoadAnimMesh(Game\Stage\Properties\Path$+"Objects/Visuals/Custom2.b3d") 
			Else
				MESHES(x) = LoadAnimMesh("Objects/Empty.b3d") : 
			EndIf 
			ExtractAnimSeq(MESHES(x),1,17)
		Case Mesh_StageVisual3	
			If FileType(Game\Stage\Properties\Path$+"Objects/Visuals/Custom3.b3d") =1 Then
				MESHES(x) = LoadAnimMesh(Game\Stage\Properties\Path$+"Objects/Visuals/Custom3.b3d") 
			Else
				MESHES(x) = LoadAnimMesh("Objects/Empty.b3d") : 
			EndIf 
			ExtractAnimSeq(MESHES(x),1,17)
		Case Mesh_StageVisual4	
			If FileType(Game\Stage\Properties\Path$+"Objects/Visuals/Custom4.b3d") =1 Then
				MESHES(x) = LoadAnimMesh(Game\Stage\Properties\Path$+"Objects/Visuals/Custom4.b3d") 
			Else
				MESHES(x) = LoadAnimMesh("Objects/Empty.b3d") : 
			EndIf 
			ExtractAnimSeq(MESHES(x),1,17)
		Case Mesh_StageVisual5
			If FileType(Game\Stage\Properties\Path$+"Objects/Visuals/Custom5.b3d") =1 Then
				MESHES(x) = LoadAnimMesh(Game\Stage\Properties\Path$+"Objects/Visuals/Custom5.b3d") 
			Else
				MESHES(x) = LoadAnimMesh("Objects/Empty.b3d") : 
			EndIf 
			ExtractAnimSeq(MESHES(x),1,17)
		...
		Case Mesh_RedRing:			MESHES(x) = LoadAnimMesh("Objects/Rings/RedRing.b3d") : ScaleEntity MESHES(x),1.1,1.1,1.1
		...
		Case Mesh_BoostBarrier:		MESHES(x) = LoadAnimMesh("Objects/Shields/BoostBarrier.b3d")
			ExtractAnimSeq(MESHES(x),1,7)
			RotateEntity MESHES(x),90,0,0
		Case Mesh_GrindSpark:			MESHES(x) = LoadAnimMesh("Objects/GrindSpark.b3d")
		...
		Case Mesh_ShieldNormal:		MESHES(x) = LoadAnimMesh("Objects/Shields/Monitor/ShieldNormal.b3d")
		Case Mesh_ShieldFlame:		MESHES(x) = LoadAnimMesh("Objects/Shields/Monitor/ShieldFlame.b3d")
		Case Mesh_ShieldBubble:		MESHES(x) = LoadAnimMesh("Objects/Shields/Monitor/ShieldBubble.b3d")
		Case Mesh_ShieldThunder:	MESHES(x) = LoadAnimMesh("Objects/Shields/Monitor/ShieldThunder.b3d")
		Case Mesh_ShieldEarth:		MESHES(x) = LoadAnimMesh("Objects/Shields/Monitor/ShieldEarth.b3d")
			
		Case Mesh_ShieldNormalX:	MESHES(x) = LoadAnimMesh("Objects/Shields/Monitor/ShieldNormalX.b3d") ScaleEntity MESHES(x),0.3,0.3,0.3
		Case Mesh_ShieldFlameX:		MESHES(x) = LoadAnimMesh("Objects/Shields/Monitor/ShieldFlameX.b3d")
		Case Mesh_ShieldBubbleX:	MESHES(x) = LoadAnimMesh("Objects/Shields/Monitor/ShieldBubbleX.b3d")
		Case Mesh_ShieldThunderX:	MESHES(x) = LoadAnimMesh("Objects/Shields/Monitor/ShieldThunderX.b3d")
		Case Mesh_ShieldEarthX:		MESHES(x) = LoadAnimMesh("Objects/Shields/Monitor/ShieldEarthX.b3d")
		...
		Case Mesh_Shard:			MESHES(x) = LoadAnimMesh("Objects/Rings/Shard.b3d") : ScaleEntity MESHES(x),1.3,1.3,1.3
		Case Mesh_SpewShard:		MESHES(x) = LoadAnimMesh("Objects/Rings/Shard.b3d") : ScaleEntity MESHES(x),1.3,1.3,1.3: PositionMesh MESHES(x),0,1.557*2,0
		...
		Case Mesh_CannonShot:		MESHES(x) = LoadAnimMesh("Objects/Bombs/Lock-on.b3d") : ScaleEntity MESHES(x),1.3,1.3,1.3
		...
		Case Mesh_Omochao:			MESHES(x) = LoadAnimMesh("Characters/Omo/model.b3d")
			i=1
		...
		Case Mesh_BoxYellow:			MESHES(x) = LoadAnimMesh("Objects/Boxes/BoxYellow.b3d")
		...
		Case Mesh_BoxLight:		MESHES(x) = LoadAnimMesh("Objects/Boxes/BoxLight.b3d")
		...
		Case Mesh_Paddle2:			MESHES(x) = LoadAnimMesh("Objects/Bumpers/Paddle2.b3d") : ScaleEntity MESHES(x),0.5,0.5,0.5
			ExtractAnimSeq(MESHES(x),1,9)
		Case Mesh_CheckpointB:		MESHES(x) = LoadAnimMesh("Objects/Checkpoint/CheckpointB.b3d") : ScaleEntity MESHES(x),1.1,1.1,1.1
		Case Mesh_Checkpoint2B:		MESHES(x) = LoadAnimMesh("Objects/Checkpoint/Checkpoint2B.b3d") : ScaleEntity MESHES(x),1.1,1.1,1.1
		Case Mesh_Checkpoint3B:		MESHES(x) = LoadAnimMesh("Objects/Checkpoint/Checkpoint3B.b3d") : ScaleEntity MESHES(x),1.1,1.1,1.1
		...
		Case Mesh_GoalRuby:			MESHES(x) = LoadAnimMesh("Objects/Rings/GoalRuby.b3d") : ScaleEntity MESHES(x),3,3,3
		...
		Case Mesh_SpringIce:			MESHES(x) = LoadAnimMesh("Objects/Springs/SpringIce.b3d") : ScaleEntity MESHES(x),1.5,1.5,1.5
			
		Case Mesh_SpringThorn:			MESHES(x) = LoadAnimMesh("Objects/Springs/SpringThorn.b3d") : ScaleEntity MESHES(x),1.5,1.5,1.5
			ExtractAnimSeq(MESHES(x),1,1);up
			ExtractAnimSeq(MESHES(x),2,2);down
			ExtractAnimSeq(MESHES(x),3,12);up to down
			ExtractAnimSeq(MESHES(x),13,21);down to up
		...
		Case Mesh_Teleporter:		;MESHES(x) = LoadAnimMesh("Objects/Springs/Teleporter.b3d") : ScaleEntity MESHES(x),3,3,3
			If FileType(Game\Stage\Properties\Path$+"Objects/Springs/Teleporter.b3d")=1 Then 
				MESHES(x) = LoadAnimMesh(Game\Stage\Properties\Path$+"Objects/Springs/Teleporter.b3d") : ScaleEntity MESHES(x),3,3,3
			Else
				MESHES(x) = LoadAnimMesh("Objects/Springs/Teleporter.b3d") : ScaleEntity MESHES(x),3,3,3
			EndIf 		
		...
		Case Mesh_Platform:			;MESHES(x) = LoadAnimMesh("Objects/Springs/Platform.b3d") : ScaleEntity MESHES(x),2,2,2
			...
			If FileType(Game\Stage\Properties\Path$+"Objects/Springs/Platform.b3d")=1 Then 
				MESHES(x) = LoadAnimMesh(Game\Stage\Properties\Path$+"Objects/Springs/Platform.b3d")
				ScaleEntity MESHES(x),1,1,1
				ExtractAnimSeq(MESHES(x),1,9)
			Else
				MESHES(x) = LoadAnimMesh("Objects/Springs/Platform.b3d")
				ScaleEntity MESHES(x),1,1,1
				ExtractAnimSeq(MESHES(x),1,9)
			EndIf 	
		...
		Case Mesh_Propeller:		;MESHES(x) = LoadAnimMesh("Objects/Fasteners/Propeller.b3d") : ScaleEntity MESHES(x),1.5,1.5,1.5
			If FileType(Game\Stage\Properties\Path$+"Objects/Fasteners/Propeller.b3d")=1 Then 
				MESHES(x) = LoadAnimMesh(Game\Stage\Properties\Path$+"Objects/Fasteners/Propeller.b3d")
			Else
				MESHES(x) = LoadAnimMesh("Objects/Fasteners/Propeller.b3d")
			EndIf 
			ExtractAnimSeq(MESHES(x),1,20)
			ScaleEntity MESHES(x),1.5,1.5,1.5
		...
		Case Mesh_FlickyS:			MESHES(x) = LoadAnimMesh("Objects/Flickies/FlickyS.b3d") : ScaleEntity MESHES(x),0.8,0.8,0.8 : ExtractAnimSeq(MESHES(x),1,9)
		...
		Case Mesh_Enemy_Pawn:				
			If FileType(Game\Stage\Properties\Path$+"Objects/Enemies/EggPawn.b3d")=1 Then
				MESHES(x) = LoadAnimMesh(Game\Stage\Properties\Path$+"Objects/Enemies/EggPawn.b3d")
			Else
				MESHES(x) = LoadAnimMesh("Objects/Enemies/EggPawn.b3d")
			EndIf 
			ScaleEntity MESHES(x),1.1,1.1,1.1
			ExtractAnimSeq(MESHES(x),1,9);idle
		...
		Case Mesh_Enemy_ArtificialChaos2:	MESHES(x) = LoadAnimMesh("Objects/Enemies/ArtificialChaos2.b3d") : ScaleEntity MESHES(x),1.1,1.1,1.1
			ExtractAnimSeq(MESHES(x),1,9);idle
		Case Mesh_Enemy_Searcher:			MESHES(x) = LoadAnimMesh("Objects/Enemies/Searcher.b3d") : ScaleEntity MESHES(x),1.1,1.1,1.1
			ExtractAnimSeq(MESHES(x),1,13);idle
		Case Mesh_Enemy_EggHunter:		MESHES(x) = LoadAnimMesh("Objects/Enemies/Hunter.b3d") : ScaleEntity MESHES(x),1.1,1.1,1.1
			ExtractAnimSeq(MESHES(x),1,13);idle
		...
		Case Mesh_Enemy_Gunner:				
			MESHES(x) = LoadAnimMesh("Objects/Enemies/EggGunner.b3d") : ScaleEntity MESHES(x),1.1,1.1,1.1
			ExtractAnimSeq(MESHES(x),1,17);idle
			ExtractAnimSeq(MESHES(x),18,34);idle1
			ExtractAnimSeq(MESHES(x),35,43);fly
