...
; /\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/\/
	...
	Function Camera_Update(c.tCamera, d.tDeltaTime)
		...
		If Not(Game\CamLock>0 Or Game\CamLock2>0 Or c\Lock\PosTimer>0) Then
			...
			If (Not(Input\Hold\MouseCamUp Or Input\Hold\MouseCamDown Or Input\Hold\MouseCamLeft Or Input\Hold\MouseCamRight)) And Game\Interface\DebugPlacerOn=0 And Game\CinemaMode=0 And Menu\Pause=0 And Menu\Settings\AutoCameraDisabled#=0 Then
