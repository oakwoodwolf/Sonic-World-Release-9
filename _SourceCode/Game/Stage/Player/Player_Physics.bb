	...
	Else
		Select char
			...
			Case CHAR_TAI,CHAR_ROU,CHAR_NAC,CHAR_WAV,CHAR_TIA,CHAR_TDL,CHAR_COM:
				Return 4.5
			Case CHAR_KNU,CHAR_CRE,CHAR_CHA,CHAR_MAR,CHAR_TIK,CHAR_BEA,CHAR_STO,CHAR_MKN,CHAR_PRS,CHAR_TRI:
				Return 4.0
...
Function GetCharJumpStrength#(char)
	...
	Else
		Select char
			Case CHAR_HBO:
				Return 7.5
			Case CHAR_AMY,CHAR_BLA,CHAR_RAY,CHAR_TIK,CHAR_NAC,CHAR_TIA,CHAR_SHD,CHAR_TRI:
				Return 7.25
...
If p\Motion\Ground Then
	Select p\Action
		...
		Case ACTION_CLIMB:
			Select p\Character
				Case CHAR_TRI: p\Physics\COMMON_XZTOPSPEED# = p\Physics\CLIMB_SPEED#*2
				Default: p\Physics\COMMON_XZTOPSPEED# = p\Physics\CLIMB_SPEED#
			End Select
