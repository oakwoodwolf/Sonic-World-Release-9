...
Function Game_Stage_UpdateProgressBar(Message$, t#)
	...
	If Game\Gameplay\Time>100 Then Return
	...
	If Menu\Stage<>0 Then
		...
		Progression = Int((t#*196.0)*(1+Menu\Settings\Debug#))
		
		; Draw message at center
		
		If Menu\Settings\Debug#=1 Then 
			DrawRealText(Message$, 10*GAME_WINDOW_SCALE#, GAME_WINDOW_H-45*GAME_WINDOW_SCALE#, (Interface_Text_1))
			Rect(10*GAME_WINDOW_SCALE#, GAME_WINDOW_H-35*GAME_WINDOW_SCALE#, 396, 50, False)
			Rect(10*GAME_WINDOW_SCALE#, GAME_WINDOW_H-35*GAME_WINDOW_SCALE#, Progression, 50, True)
		Else
...
End Function
Function Game_Stage_ParseXML_Information(xml)
	For i = 1 To xmlNodeChildCount(xml)
		
		RootChildNode = xmlNodeChild(xml, i)
				...
				For j = 1 To xmlNodeChildCount(RootChildNode)
					...
					Select xmlNodeNameGet$(InformationChildNode)
						...
						Case "music"
							...
							Game\Stage\Properties\MusicStyle = xmlNodeAttributeValueGet(InformationChildNode, "style")
							Game\CollectiblePauseMusic= xmlNodeAttributeValueGet(InformationChildNode, "collectible")
						...
						Case "fog"
							...
							Game\Stage\Properties\TargetFogR = Game\Stage\Properties\FogR
							Game\Stage\Properties\TargetFogG =Game\Stage\Properties\FogG 
							Game\Stage\Properties\TargetFogB =Game\Stage\Properties\FogB
							Game\Stage\Properties\TargetFogNearDist =Game\Stage\Properties\FogNearDist
							Game\Stage\Properties\TargetFogFarDist =Game\Stage\Properties\FogFarDist
						...
						Case "filter"
							...
							If Game\Stage\Properties\FilterOn=1 Then
								Game\Stage\Properties\FilterIntesity# = Float(xmlNodeAttributeValueGet(InformationChildNode, "intensity"))
						...
						Case "water"
							...
							If Game\Stage\Properties\Water=1 Then
								...
								Select xmlNodeAttributeValueGet(InformationChildNode, "type")
									...
									Case "paint": Game\Stage\Properties\WaterType=9
								...
								If Game\Stage\Properties\WaterType=9 Then
									Game\Stage\Properties\WaterR=xmlNodeAttributeValueGet(InformationChildNode, "r")
									Game\Stage\Properties\WaterG=xmlNodeAttributeValueGet(InformationChildNode, "g")
									Game\Stage\Properties\WaterB=xmlNodeAttributeValueGet(InformationChildNode, "b")
									fogoverride=xmlNodeAttributeValueGet(InformationChildNode, "fog")
									If fogoverride=1 Then
										Game\Stage\Properties\WaterFogR = xmlNodeAttributeValueGet(InformationChildNode, "fogr")
										Game\Stage\Properties\WaterFogG = xmlNodeAttributeValueGet(InformationChildNode, "fogg")
										Game\Stage\Properties\WaterFogB = xmlNodeAttributeValueGet(InformationChildNode, "fogb")
										Game\Stage\Properties\WaterFogNear = xmlNodeAttributeValueGet(InformationChildNode, "fognear")
										Game\Stage\Properties\WaterFogFar = xmlNodeAttributeValueGet(InformationChildNode, "fogfar")
									Else
										Game\Stage\Properties\WaterFogR = Game\Stage\Properties\WaterR
										Game\Stage\Properties\WaterFogG = Game\Stage\Properties\WaterG
										Game\Stage\Properties\WaterFogB = Game\Stage\Properties\WaterB
										Game\Stage\Properties\WaterFogNear = 0.1
										Game\Stage\Properties\WaterFogFar = 390
										
										
									EndIf
									
									EntityColor(Game\Stage\Properties\WaterMesh,Game\Stage\Properties\WaterR,Game\Stage\Properties\WaterG,Game\Stage\Properties\WaterB)
								EndIf
						...
						Case "hub"
							Game\Stage\Properties\Hub = xmlNodeAttributeValueGet(InformationChildNode, "physics")
						Case "lap"
							Game\Gameplay\TotalLapCount= xmlNodeAttributeValueGet(InformationChildNode, "count")
							If Game\Gameplay\TotalLapCount= 0 Then Game\Gameplay\TotalLapCount=3
						Case "ambience"
							Game\Stage\Properties\AmbientAlarm = xmlNodeAttributeValueGet(InformationChildNode, "alarm")
							If Game\Stage\Properties\AmbientAlarm=1 Then LoadSmartSound(Sound_AmbientAlarm)
							
							Game\Stage\Properties\AmbientBeach = xmlNodeAttributeValueGet(InformationChildNode, "beach")
							If Game\Stage\Properties\AmbientBeach=1 Then LoadSmartSound(Sound_AmbientBeach)
							
							Game\Stage\Properties\AmbientForest = xmlNodeAttributeValueGet(InformationChildNode, "forest")
							If Game\Stage\Properties\AmbientForest=1 Then LoadSmartSound(Sound_AmbientForest)
							
							Game\Stage\Properties\AmbientRain = xmlNodeAttributeValueGet(InformationChildNode, "rain")
							If Game\Stage\Properties\AmbientRain=1 Then LoadSmartSound(Sound_AmbientRain)
							
							Game\Stage\Properties\AmbientSnow = xmlNodeAttributeValueGet(InformationChildNode, "snow")
							If Game\Stage\Properties\AmbientSnow=1 Then LoadSmartSound(Sound_AmbientSnow)
							
							Game\Stage\Properties\AmbientVoid = xmlNodeAttributeValueGet(InformationChildNode, "void")
							If Game\Stage\Properties\AmbientVoid=1 Then LoadSmartSound(Sound_AmbientVoid)
							
							Game\Stage\Properties\AmbientWind = xmlNodeAttributeValueGet(InformationChildNode, "wind")
							If Game\Stage\Properties\AmbientWind=1 Then LoadSmartSound(Sound_AmbientWind)
						Case "skydome","skybox"
							If Menu\Stage<>0 Then
								If xmlNodeDataGet(InformationChildNode)<>0 Then
									If Menu\ChaoGarden=0 Or (Menu\ChaoGarden=1 And (Not(Menu\Stage=999))) Then
										Game\Stage\Properties\Skydome = LoadAnimMesh(Game\Stage\Properties\Path$+xmlNodeDataGet(InformationChildNode))
									...
									Else
										Stage_CreateCyclingSkyBox(Game\Stage\Properties\Path$)
										Game\Stage\Properties\Skydome = CopyEntity(MESHES(Mesh_Empty))
									EndIf
								Else
									;Game_Stage_LoadSkybox()
								EndIf
							Else
								Game\Stage\Properties\Skydome = CopyEntity(MESHES(Mesh_Empty))
						...
						Case "sun"
							...
							If Menu\Settings\Shadows#=1 Then DeltaYawEntity(Game\Stage\Properties\ShadowLightPivot, Game\Stage\Properties\Sun, 180 + 180)
						...
						Case "mission"
							Game\MissionValue = xmlNodeAttributeValueGet(InformationChildNode, "value")
					End Select 
				Next
		End Select
	Next
	If Menu\Stage<>0 Then xmlNodeDelete(xml)
End Function
Function Game_Stage_ParseXML_Scene(xml)
	For i = 1 To xmlNodeChildCount(xml)
			; Get child node
		RootChildNode = xmlNodeChild(xml, i)
			...
			Case "scene"
				...
				For j = 1 To xmlNodeChildCount(RootChildNode)
					...
					Select xmlNodeNameGet$(SceneChildNode)
						Case "runmesh","watermesh","mesh","animmesh","hurtmesh","deathmesh","railmesh","blockmesh","pinballmesh","rollmesh","icemesh","bouncemesh","slowmesh","grassmesh","metalmesh","dirtmesh","woodmesh"
							...
							Select xmlNodeNameGet$(SceneChildNode)
								Case "animmesh":
									m\Entity = LoadAnimMesh(Game\Stage\Properties\Path$+MeshFilename$, Game\Stage\Root)
									Animate(m\Entity,1)
								Default:
									m\Entity = LoadMesh(Game\Stage\Properties\Path$+MeshFilename$, Game\Stage\Root)
							End Select
							...
							If (MeshCollision = True) Then
								Select xmlNodeNameGet$(SceneChildNode)
									...
									Case "dirtmesh"
										EntityType(m\Entity, COLLISION_WORLD_POLYGON_DIRT)
									Case "grassmesh"
										EntityType(m\Entity, COLLISION_WORLD_POLYGON_GRASS)
									Case "woodmesh"
										EntityType(m\Entity, COLLISION_WORLD_POLYGON_WOOD)
									Case "metalmesh"
										EntityType(m\Entity, COLLISION_WORLD_POLYGON_METAL)
									Case "runmesh"
										EntityType(m\Entity, COLLISION_WORLD_POLYGON_RUN)
									Case "watermesh"
										EntityType(m\Entity, COLLISION_WORLD_POLYGON_WATER)
									Case "rollmesh"
							...
							m\InitialRotX#=EntityPitch(m\Entity,1) : m\InitialRotY#=EntityYaw(m\Entity,1) : m\InitialRotZ#=EntityRoll(m\Entity,1)
							
							SceneScale = xmlNodeFind("scale", SceneChildNode)
							If (SceneScale<>0) Then 
								m\InitialScaleX#=Float(xmlNodeAttributeValueGet(SceneScale, "x"))
								m\InitialScaleY#=Float(xmlNodeAttributeValueGet(SceneScale, "y"))
								m\InitialScaleZ#=Float(xmlNodeAttributeValueGet(SceneScale, "z"))
								ScaleEntity(m\Entity,m\InitialScaleX#,m\InitialScaleY#,m\InitialScaleZ#)
							EndIf
							...
							If (SceneAttributes <> 0) Then
								...
								SceneAttributesMoveType = xmlNodeFind("movement", SceneAttributes)
								If (SceneAttributesMoveType <> 0) Then
									m\MoveType=xmlNodeAttributeValueGet(SceneAttributesMoveType, "type") 
									
									
									m\MoveX#=xmlNodeAttributeValueGet(SceneAttributesMoveType, "x") 
									m\MoveY#=xmlNodeAttributeValueGet(SceneAttributesMoveType, "y") 
									m\MoveZ#=xmlNodeAttributeValueGet(SceneAttributesMoveType, "z") 
									
									m\MoveSpeed#=xmlNodeAttributeValueGet(SceneAttributesMoveType, "speed") 
									
									m\RotX#=xmlNodeAttributeValueGet(SceneAttributesMoveType, "pitch") 
									m\RotY#=xmlNodeAttributeValueGet(SceneAttributesMoveType, "yaw") 
									m\RotZ#=xmlNodeAttributeValueGet(SceneAttributesMoveType, "roll") 
									
									m\ScaleX#=xmlNodeAttributeValueGet(SceneAttributesMoveType, "sx") 
									m\ScaleY#=xmlNodeAttributeValueGet(SceneAttributesMoveType, "sy") 
									m\ScaleZ#=xmlNodeAttributeValueGet(SceneAttributesMoveType, "sz") 
									
									If m\MoveType=2 Then 
										m\Pivot=CreatePivot()
										m\DestinationTarget=CreatePivot()
									EndIf 
								EndIf 
								
								SceneAttributesSwitch = xmlNodeFind("switch", SceneAttributes)
								If (SceneAttributesSwitch <> 0) Then 
									m\IsSwitchMesh=1
									m\SwitchType=xmlNodeAttributeValueGet(SceneAttributesSwitch, "type") 
									m\SwitchNo=xmlNodeAttributeValueGet(SceneAttributesSwitch, "no") 
								EndIf 
								
								SceneAttributesLodType = xmlNodeFind("lod", SceneAttributes)
								If (SceneAttributesLodType <> 0) Then
									m\LodType=xmlNodeAttributeValueGet(SceneAttributesLodType, "type") 
									m\LodDistance=xmlNodeAttributeValueGet(SceneAttributesLodType, "distance") 
									m\Pivot=CreatePivot()
									
									PositionEntity(m\Pivot,m\InitialPosX#,m\InitialPosY#,m\InitialPosZ# )
									
								EndIf 
								
								SceneAttributesAlpha = xmlNodeFind("alpha", SceneAttributes)
								If (SceneAttributesAlpha <> 0) Then
									m\AlphaType=xmlNodeAttributeValueGet(SceneAttributesAlpha, "type")
									If m\AlphaType>0 Then
										m\Alpha#=xmlNodeAttributeValueGet(SceneAttributesAlpha, "fade")
										m\AlphaRate=xmlNodeAttributeValueGet(SceneAttributesAlpha, "rate")
										m\AlphaTimer=xmlNodeAttributeValueGet(SceneAttributesAlpha, "timer")
										m\TargetAlphaLower#=xmlNodeAttributeValueGet(SceneAttributesAlpha, "lower")
										m\TargetAlphaUpper#=xmlNodeAttributeValueGet(SceneAttributesAlpha, "upper")
										m\TargetAlpha#=m\TargetAlphaUpper#
									EndIf
								EndIf 
								...
								If (SceneAttributesAnimTexType <> 0) Then 
									m\AnimTexType=xmlNodeAttributeValueGet(SceneAttributesAnimTexType, "type") 
									m\DiffuseTexCount=xmlNodeAttributeValueGet(SceneAttributesAnimTexType, "count") 
										...
										Case 1:
											...
											If SceneAttributesDiffuseTex<>0 Then
												If xmlNodeAttributeValueGet(SceneAttributesDiffuseTex, "alpha")=1 Then
													m\DiffuseTexture[1]=LoadTexture(Game\Stage\Properties\Path$+xmlNodeAttributeValueGet(SceneAttributesDiffuseTex, "texture1"), 1+2)
												Else
													m\DiffuseTexture[1]=LoadTexture(Game\Stage\Properties\Path$+xmlNodeAttributeValueGet(SceneAttributesDiffuseTex, "texture1"), 1)
												EndIf
												...
												If SceneAttributesBumpTex<>0 And Menu\Settings\BumpMaps#>0 Then
													...
													bumptex=LoadTexture(Game\Stage\Properties\Path$+xmlNodeAttributeValueGet(SceneAttributesBumpTex, "texture"), 9)
													If bumptex<>0 Then
									...
									Select m\AnimTexType
										Case 2,3:
											...
											If SceneAttributesDiffuseTex<>0 Then
												If xmlNodeAttributeValueGet(SceneAttributesDiffuseTex, "alpha")=1 Then
													m\DiffuseTexture[1]=LoadTexture(Game\Stage\Properties\Path$+xmlNodeAttributeValueGet(SceneAttributesDiffuseTex, "texture1"), 1+2)
													m\DiffuseTexture[2]=LoadTexture(Game\Stage\Properties\Path$+xmlNodeAttributeValueGet(SceneAttributesDiffuseTex, "texture2"), 1+2)
													m\DiffuseTexture[3]=LoadTexture(Game\Stage\Properties\Path$+xmlNodeAttributeValueGet(SceneAttributesDiffuseTex, "texture3"), 1+2)
													m\DiffuseTexture[4]=LoadTexture(Game\Stage\Properties\Path$+xmlNodeAttributeValueGet(SceneAttributesDiffuseTex, "texture4"), 1+2)
													
												Else
													m\DiffuseTexture[1]=LoadTexture(Game\Stage\Properties\Path$+xmlNodeAttributeValueGet(SceneAttributesDiffuseTex, "texture1"), 1)
													m\DiffuseTexture[2]=LoadTexture(Game\Stage\Properties\Path$+xmlNodeAttributeValueGet(SceneAttributesDiffuseTex, "texture2"), 1)
													m\DiffuseTexture[3]=LoadTexture(Game\Stage\Properties\Path$+xmlNodeAttributeValueGet(SceneAttributesDiffuseTex, "texture3"), 1)
													m\DiffuseTexture[4]=LoadTexture(Game\Stage\Properties\Path$+xmlNodeAttributeValueGet(SceneAttributesDiffuseTex, "texture4"), 1)
								...
								SceneAttributesRed = xmlNodeFind("token", SceneAttributes)
								If (SceneAttributesRed <> 0) Then 
									m\RedRingMode=xmlNodeAttributeValueGet(SceneAttributesRed, "mode") 
									m\RedRingCount=xmlNodeAttributeValueGet(SceneAttributesRed, "count")
									Select m\RedRingMode
										Case 0
											
										Case 1
											If TOKENS>=m\RedRingCount Then HideEntity(m\Entity)
										Case 2
											If TOKENS<m\RedRingCount Then HideEntity(m\Entity) 
									End Select		
								EndIf
						...
						Case "object"
							...
							Select xmlNodeAttributeValueGet(SceneChildNode, "type")
								...
								Case "collectible"
										; Update progress bar
									Game_Stage_UpdateProgressBar("Loading object n."+j+": Collectible", Float#(j)/Float#(xmlNodeChildCount(RootChildNode)))
									TempAttribute\ObjectNo=OBJTYPE_COLLECTIBLE
									GetAttribute(ATTRIB_AMOUNT, SceneChildNode) : GetAttribute(ATTRIB_POSITION, SceneChildNode)
									GetAttribute(ATTRIB_POWER, SceneChildNode)
									GetAttribute(ATTRIB_SWITCHOBJ, SceneChildNode)
									
									If Rand(1,TempAttribute\power#) = 1 Then CreateObject()
								Case "token"
										; Update progress bar
									Game_Stage_UpdateProgressBar("Loading object n."+j+": World Token", Float#(j)/Float#(xmlNodeChildCount(RootChildNode)))
									TempAttribute\ObjectNo=OBJTYPE_TOKEN
									GetAttribute(ATTRIB_AMOUNT, SceneChildNode) : GetAttribute(ATTRIB_POSITION, SceneChildNode)
									GetAttribute(ATTRIB_POWER, SceneChildNode)
									
									If Rand(1,TempAttribute\power#) = 1 And Menu\Stage<=NonModStageAmount Then 
										CreateObject()
									Else
										TempAttribute\ObjectNo=OBJTYPE_RING
										TempAttribute\power#=5
										CreateObject()
									EndIf
								Case "diamond"
										; Update progress bar
									Game_Stage_UpdateProgressBar("Loading object n."+j+": Diamond", Float#(j)/Float#(xmlNodeChildCount(RootChildNode)))
									TempAttribute\ObjectNo=OBJTYPE_DIAMOND
									GetAttribute(ATTRIB_AMOUNT, SceneChildNode) : GetAttribute(ATTRIB_POSITION, SceneChildNode)
									GetAttribute(ATTRIB_POWER, SceneChildNode)
								...
								Case "redring"
									...
									If Menu\MissionNo<>1 Then 
										TempAttribute\ObjectNo=OBJTYPE_RING
										TempAttribute\power#=20
									EndIf
									
									If Menu\Mission=MISSION_HUNT# And TempAttribute\power#=0 Then TempAttribute\ObjectNo=OBJTYPE_SHARD
								...
								Case "gpad"
										; Update progress bar
									Game_Stage_UpdateProgressBar("Loading object n."+j+": Grind Booster", Float#(j)/Float#(xmlNodeChildCount(RootChildNode)))
									TempAttribute\ObjectNo=OBJTYPE_RAILPAD
									GetAttribute(ATTRIB_AMOUNT, SceneChildNode) : GetAttribute(ATTRIB_POSITION, SceneChildNode)
									GetAttribute(ATTRIB_ROTATION, SceneChildNode)
									GetAttribute(ATTRIB_POWER, SceneChildNode)
									GetAttribute(ATTRIB_LOCK, SceneChildNode)
								...
								Case "tramp"
										; Update progress bar
									Game_Stage_UpdateProgressBar("Loading object n."+j+": Trick Ramp", Float#(j)/Float#(xmlNodeChildCount(RootChildNode)))
									TempAttribute\ObjectNo=OBJTYPE_TRAMP
									GetAttribute(ATTRIB_AMOUNT, SceneChildNode) : GetAttribute(ATTRIB_POSITION, SceneChildNode)
									GetAttribute(ATTRIB_ROTATION, SceneChildNode)
									GetAttribute(ATTRIB_POWER, SceneChildNode)
									GetAttribute(ATTRIB_LOCK, SceneChildNode)
								...
								Case "moonring"
										; Update progress bar
									Game_Stage_UpdateProgressBar("Loading object n."+j+": Moon Ring", Float#(j)/Float#(xmlNodeChildCount(RootChildNode)))
									TempAttribute\ObjectNo=OBJTYPE_MOONRING
									GetAttribute(ATTRIB_AMOUNT, SceneChildNode) : GetAttribute(ATTRIB_POSITION, SceneChildNode)
									GetAttribute(ATTRIB_POWER, SceneChildNode)
								...
								Case "timer"
										; Update progress bar
									Game_Stage_UpdateProgressBar("Loading object n."+j+": Timer", Float#(j)/Float#(xmlNodeChildCount(RootChildNode)))
									TempAttribute\ObjectNo=OBJTYPE_TIMER
									GetAttribute(ATTRIB_AMOUNT, SceneChildNode) : GetAttribute(ATTRIB_POSITION, SceneChildNode)
									GetAttribute(ATTRIB_POWER, SceneChildNode)
								...
								Case "rshield"
										; Update progress bar
									Game_Stage_UpdateProgressBar("Loading object n."+j+": Shield Item Capsule", Float#(j)/Float#(xmlNodeChildCount(RootChildNode)))
									TempAttribute\ObjectNo=OBJTYPE_RSHIELD
									GetAttribute(ATTRIB_AMOUNT, SceneChildNode) : GetAttribute(ATTRIB_POSITION, SceneChildNode)
								...
								Case "brshield"
										; Update progress bar
									Game_Stage_UpdateProgressBar("Loading object n."+j+": Shield Item Balloon", Float#(j)/Float#(xmlNodeChildCount(RootChildNode)))
									TempAttribute\ObjectNo=OBJTYPE_RSHIELD
									GetAttribute(ATTRIB_AMOUNT, SceneChildNode) : GetAttribute(ATTRIB_POSITION, SceneChildNode)
								...
								Case "warpring"
									...
									GetAttribute(ATTRIB_AMOUNT, SceneChildNode) : GetAttribute(ATTRIB_POSITION, SceneChildNode)
									GetAttribute(ATTRIB_WARP, SceneChildNode)
									
									CreateObject()
									
								Case "missioncard"
										; Update progress bar
									Game_Stage_UpdateProgressBar("Loading object n."+j+": Mission Card", Float#(j)/Float#(xmlNodeChildCount(RootChildNode)))
									TempAttribute\ObjectNo=OBJTYPE_MISSIONCARD
									GetAttribute(ATTRIB_AMOUNT, SceneChildNode) : GetAttribute(ATTRIB_POSITION, SceneChildNode)
									GetAttribute(ATTRIB_WARP, SceneChildNode)
								...
								Case "spuna"
										; Update progress bar
									Game_Stage_UpdateProgressBar("Loading object n."+j+": Spuna", Float#(j)/Float#(xmlNodeChildCount(RootChildNode)))
									TempAttribute\ObjectNo=OBJTYPE_SPUNA
									GetAttribute(ATTRIB_AMOUNT, SceneChildNode) : GetAttribute(ATTRIB_POSITION, SceneChildNode)
									GetAttribute(ATTRIB_ROTATION, SceneChildNode)
									GetAttribute(ATTRIB_SWITCHOBJ, SceneChildNode)
								...
								Case "gunr"
									...
									TempAttribute\ObjectNo=OBJTYPE_EGUNNER
									GetAttribute(ATTRIB_AMOUNT, SceneChildNode) : GetAttribute(ATTRIB_POSITION, SceneChildNode)
									GetAttribute(ATTRIB_ROTATION, SceneChildNode)
									GetAttribute(ATTRIB_SWITCHOBJ, SceneChildNode)
									GetAttribute(ATTRIB_CARNIVAL, SceneChildNode)
								...
								Case "inactive"
										; Update progress bar
									Game_Stage_UpdateProgressBar("Loading object n."+j+": Inactive Enemy", Float#(j)/Float#(xmlNodeChildCount(RootChildNode)))
									TempAttribute\ObjectNo=OBJTYPE_INACTIVE
									GetAttribute(ATTRIB_AMOUNT, SceneChildNode) : GetAttribute(ATTRIB_POSITION, SceneChildNode)
									GetAttribute(ATTRIB_ROTATION, SceneChildNode)
									GetAttribute(ATTRIB_SWITCHOBJ, SceneChildNode)
									GetAttribute(ATTRIB_CARNIVAL, SceneChildNode)
								...
								Case "lapstart"
										; Update progress bar
									Game_Stage_UpdateProgressBar("Loading object n."+j+": Lap Trigger", Float#(j)/Float#(xmlNodeChildCount(RootChildNode)))
									TempAttribute\ObjectNo=OBJTYPE_TRIGGER_LAPSTART
									GetAttribute(ATTRIB_AMOUNT, SceneChildNode) : GetAttribute(ATTRIB_POSITION, SceneChildNode)
									GetAttribute(ATTRIB_POWER, SceneChildNode)
									CreateObject()
								Case "voice"
										; Update progress bar
									Game_Stage_UpdateProgressBar("Loading object n."+j+": Voice Trigger", Float#(j)/Float#(xmlNodeChildCount(RootChildNode)))
									TempAttribute\ObjectNo=OBJTYPE_TRIGGER_VOICE
									GetAttribute(ATTRIB_AMOUNT, SceneChildNode) : GetAttribute(ATTRIB_POSITION, SceneChildNode)
									GetAttribute(ATTRIB_POWER, SceneChildNode)
									GetAttribute(ATTRIB_HINT, SceneChildNode)
									CreateObject()
								...
								Case "fog"
										; Update progress bar
									Game_Stage_UpdateProgressBar("Loading object n."+j+": Fog Trigger", Float#(j)/Float#(xmlNodeChildCount(RootChildNode)))
									TempAttribute\ObjectNo=OBJTYPE_TRIGGER_FOG
									GetAttribute(ATTRIB_AMOUNT, SceneChildNode) : GetAttribute(ATTRIB_POSITION, SceneChildNode)
									GetAttribute(ATTRIB_POWER, SceneChildNode)
									GetAttribute(ATTRIB_FOG, SceneChildNode)
									CreateObject()
									
									
								Case "dest"
										; Update progress bar
									Game_Stage_UpdateProgressBar("Loading object n."+j+": Destination Trigger", Float#(j)/Float#(xmlNodeChildCount(RootChildNode)))
									TempAttribute\ObjectNo=OBJTYPE_TRIGGER_DEST
									GetAttribute(ATTRIB_AMOUNT, SceneChildNode) : GetAttribute(ATTRIB_POSITION, SceneChildNode)
									GetAttribute(ATTRIB_POWER, SceneChildNode)
									GetAttribute(ATTRIB_DESTINATION, SceneChildNode)
									CreateObject()
								...
								Case "lapcheck"
										; Update progress bar
									Game_Stage_UpdateProgressBar("Loading object n."+j+": Lap Trigger", Float#(j)/Float#(xmlNodeChildCount(RootChildNode)))
									TempAttribute\ObjectNo=OBJTYPE_TRIGGER_LAPCHECK
									GetAttribute(ATTRIB_AMOUNT, SceneChildNode) : GetAttribute(ATTRIB_POSITION, SceneChildNode)
									GetAttribute(ATTRIB_POWER, SceneChildNode)
									GetAttribute(ATTRIB_TELEPORTER, SceneChildNode)
									GetAttribute(ATTRIB_POWER, SceneChildNode)
								...
								Case "iswitch"
										; Update progress bar
									Game_Stage_UpdateProgressBar("Loading object n."+j+": Switch", Float#(j)/Float#(xmlNodeChildCount(RootChildNode)))
									TempAttribute\ObjectNo=OBJTYPE_SWITCHINVIS
									GetAttribute(ATTRIB_AMOUNT, SceneChildNode) : GetAttribute(ATTRIB_POSITION, SceneChildNode)
									GetAttribute(ATTRIB_ROTATION, SceneChildNode)
									GetAttribute(ATTRIB_SWITCH, SceneChildNode)
								...
								Case "shop"
										; Update progress bar
									Game_Stage_UpdateProgressBar("Loading object n."+j+": Shop Trigger", Float#(j)/Float#(xmlNodeChildCount(RootChildNode)))
									TempAttribute\ObjectNo=OBJTYPE_TRIGGER_SHOP
									GetAttribute(ATTRIB_AMOUNT, SceneChildNode) : GetAttribute(ATTRIB_POSITION, SceneChildNode)
									GetAttribute(ATTRIB_POWER, SceneChildNode)
									GetAttribute(ATTRIB_LOCK, SceneChildNode)
									GetAttribute(ATTRIB_CAM, SceneChildNode)
								...
								Case "soundtest"
										; Update progress bar
									Game_Stage_UpdateProgressBar("Loading object n."+j+": Sound Test Trigger", Float#(j)/Float#(xmlNodeChildCount(RootChildNode)))
									TempAttribute\ObjectNo=OBJTYPE_TRIGGER_SOUNDTEST
									GetAttribute(ATTRIB_AMOUNT, SceneChildNode) : GetAttribute(ATTRIB_POSITION, SceneChildNode)
									GetAttribute(ATTRIB_POWER, SceneChildNode)
									GetAttribute(ATTRIB_LOCK, SceneChildNode)
									GetAttribute(ATTRIB_CAM, SceneChildNode)
								...
								Case "atm"
										; Update progress bar
									Game_Stage_UpdateProgressBar("Loading object n."+j+": ATM Trigger", Float#(j)/Float#(xmlNodeChildCount(RootChildNode)))
									TempAttribute\ObjectNo=OBJTYPE_TRIGGER_ATM
									GetAttribute(ATTRIB_AMOUNT, SceneChildNode) : GetAttribute(ATTRIB_POSITION, SceneChildNode)
									GetAttribute(ATTRIB_POWER, SceneChildNode)
								...
								Default
									For vs = 1 To VISUAL_AMOUNT
										If xmlNodeAttributeValueGet(SceneChildNode, "type") = "visual"+Str(vs) Then
											Game_Stage_UpdateProgressBar("Loading object n."+j+": Stage Visual", Float#(j)/Float#(xmlNodeChildCount(RootChildNode)))
											
											
											TempAttribute\ObjectNo=OBJTYPE_VISUAL[vs]
											GetAttribute(ATTRIB_AMOUNT, SceneChildNode) : GetAttribute(ATTRIB_POSITION, SceneChildNode)
											GetAttribute(ATTRIB_ROTATION, SceneChildNode)
											GetAttribute(ATTRIB_POWER, SceneChildNode)
											GetAttribute(ATTRIB_VISUAL, SceneChildNode)
											GetAttribute(ATTRIB_SWITCHOBJ, SceneChildNode)
